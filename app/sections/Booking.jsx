...
function Booking() {
  return (
    <div className='bg-rental_beige_3 py-16'>
      ...
      <div className='flex gap-16 justify-center py-5 bg-rental_primary w-[70%] items-center mx-auto mt-14 rounded-full'>
        <div className='flex flex-col gap-2'>
          <h4 className='text-[18px] text-rental_beige_3'>Where</h4>
        ...
        <div className='flex flex-col gap-2'>
          <h4 className='text-[18px] text-rental_beige_3'>Check-In Date</h4>
        ...
        <div className='flex flex-col gap-2'>
          <h4 className='text-[18px] text-rental_beige_3'>Check-Out Date</h4>
        ...
        <div className='flex flex-col gap-2'>
          <h4 className='text-[18px] text-rental_beige_3'>Guests</h4>
          <input type="number" placeholder='How many are you?' min="1" max="4" required className='px-3 py-2 placeholder:text-[13px] outline-none text-rental_dark_choc rounded-lg bg-rental_beige_3' />
        </div>
