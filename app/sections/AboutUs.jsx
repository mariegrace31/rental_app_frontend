    ...
    <div className='bg-white py-20'>
      ...
      <div className='flex gap-7 p-14 mx-auto justify-center items-center w-[85%]'>
        <div className='flex flex-col gap-5'>
          <h2 className='text-rental_primary font-medium text-[25px]'>Rento: Your Trusted Platform for Easy and Reliable Apartment Rentals</h2>
          <p className='text-[17px] font-light'>At Rento, we make finding and booking apartments easy, fast, and reliable. Whether you're looking for a short-term stay or a long-term rental,
